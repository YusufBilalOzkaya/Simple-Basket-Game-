...
// include: /tmp/tmpqambe3b6.js
  ...
  (() => {
    ...
    loadPackage({"files": [{"filename": "/pota.png", "start": 0, "end": 117352}], "remote_package_size": 117352});

  })();

// end include: /tmp/tmpqambe3b6.js
// include: /tmp/tmpo2zmkhom.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpo2zmkhom.js
// include: /tmp/tmpe_89zdzl.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpe_89zdzl.js
...
var ASM_CONSTS = {
  92254: () => { if (document.fullscreenElement) return 1; },  
 92300: () => { return Module.canvas.width; },  
 92332: () => { return parseInt(Module.canvas.style.width); },  
 92380: () => { document.exitFullscreen(); },  
 92407: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 92479: () => { if (document.fullscreenElement) return 1; },  
 92525: () => { return Module.canvas.width; },  
 92557: () => { return screen.width; },  
 92582: () => { document.exitFullscreen(); },  
 92609: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 92803: () => { return window.innerWidth; },  
 92829: () => { return window.innerHeight; },  
 92856: () => { if (document.fullscreenElement) return 1; },  
 92902: () => { return Module.canvas.width; },  
 92934: () => { return parseInt(Module.canvas.style.width); },  
 92982: () => { if (document.fullscreenElement) return 1; },  
 93028: () => { return Module.canvas.width; },  
 93060: () => { return screen.width; },  
 93085: () => { return window.innerWidth; },  
 93111: () => { return window.innerHeight; },  
 93138: () => { if (document.fullscreenElement) return 1; },  
 93184: () => { return Module.canvas.width; },  
 93216: () => { return screen.width; },  
 93241: () => { document.exitFullscreen(); },  
 93268: () => { if (document.fullscreenElement) return 1; },  
 93314: () => { return Module.canvas.width; },  
 93346: () => { return parseInt(Module.canvas.style.width); },  
 93394: () => { document.exitFullscreen(); },  
 93421: ($0) => { Module.canvas.style.opacity = $0; },  
 93459: () => { return screen.width; },  
 93484: () => { return screen.height; },  
 93510: () => { return window.screenX; },  
 93537: () => { return window.screenY; },  
 93564: () => { return window.devicePixelRatio; },  
 93600: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93653: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 93704: () => { Module.canvas.style.cursor = 'none'; },  
 93741: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 93997: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94048: () => { if (document.pointerLockElement) return 1; },  
 94095: () => { if (document.fullscreenElement) return 1; },  
 94141: () => { return window.innerWidth; },  
 94167: () => { return window.innerHeight; }
};
